...
public class DropdownPractices {
    ...
    public void tc1_simple_dropdown_test(){
     ...
     //3. Verify “Simple dropdown” default selected value is correct
        ...
        WebElement currentSelectionOption = simpleDropdown.getFirstSelectedOption();

        String  actualTextOfCurrentSelectionOption = currentSelectionOption.getText();
        String expectedTest = "Please select an option";

        //Assert.assertTrue(actualTextOfCurrentSelectionOption.equals(expectedTest));
        Assert.assertEquals(actualTextOfCurrentSelectionOption,expectedTest);
